...
const StartGameModal = ({ setDifficulty, actualUsername }: StartGameModalProps) => {
  return <div className="p-4 mt-4 border-4 border-black border-solid rounded-lg">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-4 gap-y-4 pt-4">
      ...
      <div className="difficulty">
        <NavLink to={'/medium'} className="bg-blue-600 button link" onClick={() => { setDifficulty('medium') }}>Medium</NavLink>
        <ul>
          <li>5 Minutes</li>
          <li>32 Cards</li>
        </ul>
      ...
      <div className="difficulty">
        <NavLink to={'/hard'} className="bg-red-600 button link" onClick={() => { setDifficulty('hard') }}>Hard</NavLink>
        <ul>
          <li>5 Minutes</li>
          <li>64 Cards</li>
        </ul>
